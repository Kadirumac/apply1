...
import textureUrl from '../resources/images/software1.jpg'
...
function Background() {
  ...
  const adaptedHeight = 3800 * (aspect > 5000 / 3800 ? viewport.width /12000 : viewport.height / 3800)
...
function Diamonds() {
  ...
  return (
    <instancedMesh ref={model} args={[null, null, diamonds.length]} onClick={()=>{console.log('ok') }}>
...
export default function Refraction() {
  return (
    <Canvas camera={{ fov: 50, position: [0, 0, 30] }} style={{height:'60vh'}}>
